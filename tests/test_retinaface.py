...
class TestRetinaFace(unittest.TestCase):
    ...
    def test1(self):
        ...
        self.assertEqual(r5.shape, (24, 5))
        self.assertEqual(r6.shape, (20, 5))
        np.testing.assert_almost_equal(r5[10], np.array([541., 105., 591., 169., 0.99779]), decimal=5)
        np.testing.assert_almost_equal(r5[22], np.array([585., 129., 612., 164., 0.02089]), decimal=5)
        np.testing.assert_almost_equal(r6[4], np.array([931., 213., 981., 282., 0.98094]), decimal=5)
        np.testing.assert_almost_equal(r6[8], np.array([298., 194., 355., 270., 0.04269]), decimal=5)
